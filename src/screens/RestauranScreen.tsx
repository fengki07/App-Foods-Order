...
import { FoodModel, Restaurant, UserState } from '../redux/models';
...
const RestaurantScreens : React.FC<RestaurantProps> = (props) => {
    ...
    const restaurant = getparam('restauran') as Restaurant
    ...
    return  (
        <View style={styles.container}>
            ...
            <ButtonWhiteIcon icon={require('../images/back_arrow.png')} onTap={()=> goBack()} height={42} width={42}/>
            ...
            <Text style={{color: '#FFF', fontSize: 25, fontWeight: '500'}}>{restaurant.addresss}{restaurant.phone}</Text>
            </View>
            </ImageBackground>
            <FlatList 
